...
// 최신순 조회 예시
const createdDateUrl = `http://exhibition-place.site:8080/exhibitions?searchWord=&categoryName=photo&page=&size=&sort=createdDate,desc`;
// 인기순 조회 예시
const likeCountUrl = `http://exhibition-place.site:8080/exhibitions?searchWord=&categoryName=photo&page=&size=&sort=likeCount,desc`;
// 조회수순 조회 예시
const viewCountUrl = `http://exhibition-place.site:8080/exhibitions?searchWord=&categoryName=photo&page=&size=&sort=viewCount,desc`;
