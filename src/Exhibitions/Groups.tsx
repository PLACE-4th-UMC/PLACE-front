...
function Groups() {
  ...
  const [exhibitsData, setExhibitsData] = useState<ExhibitItem[]>(exhibitiondata);
  ...
  return (
    <div>
    <Header/>
    <div style={{ width: "100%", maxWidth: "1366px", margin: "0 auto", flexDirection: "row", display: "flex"}}>
      <div>
