...
// 최신순 조회 예시
const createdDateUrl = `http://exhibition-place.site:8080/exhibitions?searchWord=&categoryName=install&page=&size=&sort=createdDate,desc`;
// 인기순 조회 예시
const likeCountUrl = `http://exhibition-place.site:8080/exhibitions?searchWord=&categoryName=install&page=&size=&sort=likeCount,desc`;
// 조회수순 조회 예시
const viewCountUrl = `http://exhibition-place.site:8080/exhibitions?searchWord=&categoryName=install&page=&size=&sort=viewCount,desc`;
...
<div>
    ...
    <div style={{ marginTop: "92px", marginLeft: "79px",  width: "605px", height: "98px", flexShrink: "0" }}>
        ...
        설치미술 전시
        <div style={{ marginTop: "17px", marginBottom: "24px", marginRight: "0px", display: "center", width: "220px", height: "6px", flexShrink: 0, borderRadius: "3px", backgroundColor: "#E52A2A" }}></div>
        </div>
    </div>
